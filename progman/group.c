...
GROUP_GroupWndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    group = (PROGGROUP*)GetWindowLong(hWnd, 0);
    ...
    switch (uMsg)
    {
        case WM_NCCREATE:
        {
            ...
            SetWindowLong(hWnd, 0, (LONG)group);
        ...
        case WM_SIZE:
        {
            ...
            AdjustWindowRectEx(&rect, GetWindowLong(group->hListView, GWL_STYLE), FALSE, GetWindowLong(group->hListView, GWL_EXSTYLE));
        ...
        case WM_NCLBUTTONDOWN:
            Globals.hActiveGroup = (PROGGROUP*)GetWindowLong(hWnd, 0);
